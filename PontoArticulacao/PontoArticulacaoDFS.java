...
class PontoArticulacaoDFS
{
    ...
    public void showResults()
    {
        ...
        System.out.println("Número de pontos de articulação: " + articulationPointList.size());
        ...
        /*
        System.out.println("Número de vértices de corte: " + bccList.size());

        if(bccList.isEmpty())
        {
            System.out.println("O grafo é Biconexo.");
        }
